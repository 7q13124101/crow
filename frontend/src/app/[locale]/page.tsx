...
export default async function HomePage() {
  ...
  const techItems = [
    "Next.js 15", "React 19", "TypeScript", "Tailwind CSS", "FastAPI", "PydanticAI", "SQLAlchemy", "PostgreSQL", "Redis", "Celery", "Docker", "Traefik", "JWT Auth",
 "WebSockets", "Logfire", "OpenTelemetry",
 "next-intl",
